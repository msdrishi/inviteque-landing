...
const defaultPhoto1 = "/assets/templates/royal-heirloom/hemang-photo-1.webp"
const defaultPhoto2 = "/assets/templates/royal-heirloom/hemang-photo-2.webp"
const defaultPhoto3 = "/assets/templates/royal-heirloom/hemang-photo-3.webp"

export default function CustomRoyalHeirloomHemangAndJasmine({ groupSlug: propGroupSlug }) {
  ...
  const weddingDateStr = (() => {
    ...
    if (savedData?.weddingDate) return savedData.weddingDate
  ...
  const weddingMonth = (() => {
    ...
    if (savedData?.weddingMonth) return savedData.weddingMonth
  ...
  const weddingYear = (() => {
    ...
    if (savedData?.weddingYear) return savedData.weddingYear
    if (draftData?.weddingYear) return draftData.weddingYear
    return '2026'
  })()
  const weddingTime = (savedData ? (savedData.heroData?.weddingTime || savedData.weddingTime) : draftData?.weddingTime) || '07:00 PM'
  ...
  const venueDateTime = `${weddingDateStr} ${weddingMonth}, ${weddingYear}\n${formattedTime}`
  ...
  // Full Screen Events directly from data.js
  const filteredFullScreenEvents = useMemo(() => {
    return savedData?.eventsData || []
  }, [savedData])
  ...
  const showSchedule = baseShowSchedule
  ...
  return (
    <div className="relative min-h-screen bg-[#181311] text-[#4A3326] flex justify-center selection:bg-[#E8C29D]/40">
      <main className="w-full min-h-[100dvh] bg-[#ECE3D1] overflow-x-hidden relative font-['Cormorant_Garamond']">
        
        {/* ── LOADING SPLASH ── */}
        <SplashScreen loading={showLoadingSplash} />

        <div className="relative w-full max-w-[480px] md:max-w-[820px] mx-auto bg-[#ECE3D1] shadow-2xl overflow-hidden shadow-[#4A2810]/10 flex flex-col">
