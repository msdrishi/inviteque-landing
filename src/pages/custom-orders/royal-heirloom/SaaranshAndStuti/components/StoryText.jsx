...
export default function StoryText({ brideName, groomName, customMessage }) {
          ...
          <div className="w-full relative h-full">
            ...
            <div className="w-full bg-[#FAF5EB] border-x border-[#D8C7B0] flex flex-col items-center text-center px-6 pt-10 pb-4 relative">
              ...
              <p className="font-['Cormorant_Garamond'] text-[18px] sm:text-[20px] text-[#5A3825] leading-[1.6] italic mb-6 font-normal">
                {customMessage || "“What started as an ordinary afternoon turned into a timeless bond. Through quiet shared laughter, heartfelt conversations over endless cups of chai, and unspoken understanding, we realized that home was never a place — it was each other.”"}
              </p>
