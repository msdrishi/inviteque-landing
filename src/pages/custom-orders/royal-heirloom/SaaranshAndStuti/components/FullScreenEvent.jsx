...
import cocktailBg from '../../../../../templates/royal-heirloom/cocktail.webp';
import haldiBg from '../../../../../templates/royal-heirloom/haldi.webp';
import poojaBg from '../../../../../templates/royal-heirloom/pooja.webp';
...
export default function FullScreenEvent({ event }) {
  ...
  return (
    <section 
      className="relative min-h-[100dvh] w-full flex flex-col justify-start items-center overflow-hidden bg-[#ECE3D1] border-t border-[#4A2810]/10 px-6 pt-16 bg-cover bg-center"
    ...
    >
      <motion.div
        ...
        className="relative z-10 flex flex-col items-center justify-center w-full text-center max-w-sm mx-auto min-h-[45dvh]"
      >
        ...
        <motion.div variants={fadeInUp} className="flex flex-col items-center gap-1 mb-8">
          <p className="font-['Cormorant_Garamond'] text-lg font-bold text-[#4A2810] uppercase tracking-widest">
            Venue
          </p>
          <p className="font-['Cormorant_Garamond'] text-base text-[#4A2810]/80">
            {event.venueName}
          </p>
          <p className="font-['Cormorant_Garamond'] text-sm text-[#4A2810]/70">
            {event.venueCity}
          </p>
        </motion.div>
