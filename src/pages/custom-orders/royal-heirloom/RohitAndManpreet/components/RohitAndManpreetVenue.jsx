  ...
  return (
    <section className="relative w-full aspect-[941/1672] min-h-[100svh] flex flex-col px-6 pt-10 pb-8 bg-[#F4EDE2] border-t border-[#D5C6AC] overflow-hidden">
      ...
      >
        ...
        {dateTime && (
          <motion.div variants={itemVariants} className="flex flex-col items-center justify-center my-1.5 px-3 py-1 bg-[#8C5D38]/5 rounded-md border border-[#8C5D38]/20">
            <p className="font-['Cinzel'] text-[12px] sm:text-[13px] tracking-widest uppercase text-[#8C5D38] font-semibold text-center leading-snug whitespace-pre-line">
              {dateTime}
            </p>
          </motion.div>
        )}

        <motion.p variants={itemVariants} className="font-['Cinzel'] text-[13px] sm:text-[14px] tracking-wider uppercase text-[#683C1A] leading-relaxed max-w-[280px] font-medium mt-1">
          {fullAddress}
        </motion.p>
