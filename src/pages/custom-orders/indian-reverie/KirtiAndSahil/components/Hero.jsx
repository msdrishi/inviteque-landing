      ...
      {hasOpened && (
        ...
        >
          ...
          <motion.div variants={lineAnim} className="flex flex-col items-center mb-2 mt-4 overflow-visible">
            <h1 className="font-['Modernline',_'Allura',_'Alex_Brush',_cursive] text-[56px] leading-none select-none font-normal drop-shadow-sm" style={{ color: C.primary }}>
              <BlurText text={data.groomName} delay={0.8} />
            </h1>
            <p className="font-['Modernline',_'Allura',_'Alex_Brush',_cursive] text-4xl -my-4 z-10" style={{ color: C.gold }}>
              &
            </p>
            <h1 className="font-['Modernline',_'Allura',_'Alex_Brush',_cursive] text-[56px] leading-none select-none font-normal drop-shadow-sm" style={{ color: C.primary }}>
